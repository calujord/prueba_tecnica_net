    ...
    public async Task<R> Handle(IdentifiedCommand<T, R> message, CancellationToken cancellationToken)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                switch (command)
                {
                    case CreateSettlementBankCommand createSettlementBankCommand:
                        idProperty = nameof(createSettlementBankCommand.Bic);
                        commandId = createSettlementBankCommand.Bic;
                        break;
